...
float* runMeasuresForASingleDataset ( ComplexityMeasures* dSet, InputOptions& opts ) {
    ...
    unsigned int all_t = Utils::getTime();
    ...
    cout << "F1 processing time: " << Utils::getTime() - start_t << endl;
    ...
    cout << "F1v processing time: " << Utils::getTime() - start_t << endl;
    ...
    cout << "F2 processing time: " << Utils::getTime() - start_t << endl;
    ...
    cout << "F3 processing time: " << Utils::getTime() - start_t << endl;
    ...
    cout << "F4 processing time: " << Utils::getTime() - start_t << endl;
    ...
    cout << "SMO processing time: " << Utils::getTime() - start_t << endl;
    ...
    cout << "L1 processing time: " << Utils::getTime() - start_t << endl;
    ...
    cout << "L2 processing time: " << Utils::getTime() - start_t << endl;
    ...
    cout << "L3 processing time: " << Utils::getTime() - start_t << endl;
    ...
    cout << "N1 processing time: " << Utils::getTime() - start_t << endl;
    ...
    cout << "N2 processing time: " << Utils::getTime() - start_t << endl;
    ...
    cout << "N3 processing time: " << Utils::getTime() - start_t << endl;
    ...
    cout << "N4 processing time: " << Utils::getTime() - start_t << endl;
    ...
    cout << "T1 processing time: " << Utils::getTime() - start_t << endl;
    ...
    cout << "T2 processing time: " << Utils::getTime() - start_t << endl;
    ...
    */
    ...
    cout << "Total processing time: " << Utils::getTime() - all_t << endl;
...
float** runMeasures ( InputOptions& opts, std::string*& datasetNames, int& numberOfDatasets ) {
    ...
    cout << "Preparing data time: " << Utils::getTime() - start_t << endl;
